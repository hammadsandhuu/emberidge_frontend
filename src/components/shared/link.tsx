...
> = ({ children, className, title, variant = "line", ...props }) => {
  ...
  const rootClassName = cn(
    "group ",
    {
      ...
      [`inline-block text-center min-w-[150px] flex px-4 py-2  relative leading-6 text-brand-light font-medium rounded-full text-[13px] transition-all bg-primary-500 hover:bg-primary-400`]:
